  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <ExportButtons fileName={`dung-han-${thang}.xlsx`} sheets={excelSheets} />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-lg border border-green-200 bg-green-50 p-3">
          <div className="text-2xl font-semibold text-green-700">{kq.dungHan}</div>
          <div className="text-xs text-gray-500">Đúng hạn</div>
        </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {kq.danhSachTre.map((d) => (
                <tr key={d.MaDon}>
                  ...
                  <td className="px-2 py-1">{d.ngayHoanThanh ?? "(chưa xong)"}</td>
